...
import { container, videoWrap, headingWrap, dimmed } from './HeroSection.module.scss';
...
const HeroSection: React.FC<HeroSectionProps> = () => {
  ...
  useEffect(() => {
    ...
    three.on("resize", ({ width, height }) => {
      ...
      zoomMaterial.uniforms.zoomSize.value = 200 / Math.sqrt(width * width + height * height);
    });
  ...
  return (
    <section className={container}>
      ...
      <div className={headingWrap} ref={ref}></div>
    </section>
  );
}
